...
void SecondTower::fire()
{
    ...
    //set grapchics
    bullet->setPixmap(QPixmap(":/resourses/pic/secondtowerbullet.png"));
    bullet1->setPixmap(QPixmap(":/resourses/pic/secondtowerbullet.png"));
    bullet2->setPixmap(QPixmap(":/resourses/pic/secondtowerbullet.png"));
